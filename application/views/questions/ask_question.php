    ...
    <div class="container col-7 mt-5">
        ...
        <form action="<?php echo base_url('index.php/submit_question'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <small id="titleHelp" class="form-text text-muted">Title must be at least 15 characters.</small>
            </div>
            
            <!-- Body -->
            <div class="form-group">
                <label for="body">Body</label>
                <textarea class="form-control" id="body" name="body" rows="6" required placeholder="The body of your question contains your problem details and results. Minimum 220 characters."></textarea>
            </div>
            
            <!-- Tags -->
            <div class="form-group">
                <label for="tags">Tags</label>
                <input type="text" class="form-control" id="tags" name="tags" placeholder="Add up to 5 tags to describe what your question is about. Start typing to see suggestions.">
